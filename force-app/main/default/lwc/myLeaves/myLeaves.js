...
export default class MyLeaves extends LightningElement {
    ...
    successHandler(event) {
        this.showModalPopup = false;
        this.showToast('Leave request submitted successfully and is pending approval');
    ...
    submitHandler(event) {
        ...
        let fromDate = new Date(fields.From_Date__c);
        fromDate.setHours(0, 0, 0, 0);

        let toDate = new Date(fields.To_Date__c);
